...
type Config struct {
	...
	NodeConfig       *NodeConfig   `protobuf:"bytes,26,opt,name=node_config,json=nodeConfig" json:"node_config,omitempty"`
...
type NodeConfig struct {
	NodeExecutablePath []byte `protobuf:"bytes,1,opt,name=node_executable_path,json=nodeExecutablePath" json:"node_executable_path,omitempty"`
	XXX_unrecognized   []byte `json:"-"`
}
...
func (m *NodeConfig) GetNodeExecutablePath() []byte {
	if m != nil {
		return m.NodeExecutablePath
	}
	return nil
}
...
func init() {
	...
	proto.RegisterType((*NodeConfig)(nil), "appengine.tools.devappserver2.NodeConfig")
