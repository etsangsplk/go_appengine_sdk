...
func (x Index_Version) String() string {
	return proto.EnumName(Index_Version_name, int32(x))
}
func (x *Index_Version) UnmarshalJSON(data []byte) error {
	value, err := proto.UnmarshalJSONEnum(Index_Version_value, data, "Index_Version")
	if err != nil {
		return err
	}
	*x = Index_Version(value)
	return nil
}
...
type Index struct {
	...
	Parent           *bool             `protobuf:"varint,7,opt,name=parent" json:"parent,omitempty"`
	Version          *Index_Version    `protobuf:"varint,8,opt,name=version,enum=datastore.Index_Version,def=0" json:"version,omitempty"`
...
const Default_Index_Version Index_Version = Index_VERSION_UNSPECIFIED
...
func (m *Index) GetVersion() Index_Version {
...
func init() {
	...
	proto.RegisterEnum("datastore.Index_Version", Index_Version_name, Index_Version_value)
