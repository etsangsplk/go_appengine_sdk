...
_FILEOPTIONS = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='cc_deprecated_maps_implementation', full_name='proto2.FileOptions.cc_deprecated_maps_implementation', index=26,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='objc_class_prefix', full_name='proto2.FileOptions.objc_class_prefix', index=27,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='csharp_namespace', full_name='proto2.FileOptions.csharp_namespace', index=28,
...
_ENUMOPTIONS = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='uninterpreted_option', full_name='proto2.EnumOptions.uninterpreted_option', index=4,
      number=999, type=11, cpp_type=10, label=3,
      has_default_value=False, default_value=[],
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
